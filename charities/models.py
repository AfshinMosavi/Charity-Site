...
class Benefactor(models.Model):
    ...
    user = models.OneToOneField(User, on_delete=models.CASCADE, related_name='benefactor_profile')
...
class Task(models.Model):
    ...
    assigned_benefactor = models.ForeignKey(Benefactor, on_delete=models.SET_NULL, null=True, blank=True, related_name='tasks_assigned')
    ...
    gender_limit = models.CharField(max_length=1, choices = GENDER_LIMIT_CHOICES, null=True, blank=True )
    state = models.CharField(max_length=1, choices= TaskStatus.choices, default=TaskStatus.PENDING)
